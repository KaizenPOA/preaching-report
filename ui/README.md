...
* [`src/cljs/ui/`](src/cljs/ui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/ui/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/ui/`](test/cljs/ui/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `ui` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ui/config.cljs) defaults to `true` in
